...
if (!gallery.includes("import { useEffect }")) {
    gallery = gallery.replace("import { useState } from 'react'", "import { useState, useEffect } from 'react'");
}
...
console.log('Fixed Gallery imports');
